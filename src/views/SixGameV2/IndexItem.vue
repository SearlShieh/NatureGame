<template>
  <div>
    ...
    <!-- 状态提示 -->
    <div style="text-align: center;color: #d36561; font-size: 3vw;position: relative;top: -2vw;" class="status" v-if="times > 0">
      亲爱的小宝，你还有 {{ times }} 次机会！
    </div>
...
<script setup lang="ts">
  ...
  onMounted(() => {
    itemWidth.value = (window.innerWidth*0.7 - (props.size-1)*1) / props.size;
...
<style lang="scss" scoped>
  ...
  .container_menu_item-again{
    background-image: url('../../assets/SixGame/btn/again.png')
  }
  .container_menu_item-save{
    background-image: url('../../assets/SixGame/btn/save.png')
  }
  .container_menu_item{
    height: 40px;
  }
