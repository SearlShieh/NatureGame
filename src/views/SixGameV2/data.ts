...
export const SixData: SixDataType[] = [
  ...
  { name: 'tunjinshou', min: 1, max: 2, add: 0.6 },
  { name: 'guixi', min: 4, max: 6, add: 1 },
  { name: 'xuelian', min: 5, max: 8, add: 1.5 },
  { name: 'wadang', min: 1, max: 2, add: 1.1 },
  { name: 'fengzheng', min: 3, max: 6, add: 1.5 },
  ...
  { name: 'jinlin', min: 4, max: 6, add: 1.5 },
  { name: 'hufu', min: 3, max: 5, add: 1.1 },
];
...
export const SixDataLY: SixDataType[] = [
  ...
  { name: 'tunjinshou', min: 1, max: 3, add: 0.7 },
  { name: 'guixi', min: 3, max: 5, add: 1.1 },
  { name: 'hua', min: 6, max: 8, add: 1.6 },
  { name: 'wadang', min: 1, max: 2, add: 1 },
  { name: 'fengzheng', min: 3, max: 6, add: 1.5 },
  { name: 'jinzun', min: 2, max: 3, add: 1 },
  { name: 'tongjing', min: 3, max: 6, add: 1.3 },
  { name: 'dizi', min: 3, max: 6, add: 1.5 },
  { name: 'gou', min: 3, max: 5, add: 1 },
];
