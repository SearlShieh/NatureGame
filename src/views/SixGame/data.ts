...
export const SixData: SixDataType[] = [
  ...
  { name: 'xuelian', min: 8, max: 10, add: 1.5 },
  { name: 'mao', min: 1, max: 3, add: 1 },
  { name: 'baiyou', min: 2, max: 4, add: 1.5 },
  { name: 'taoyong', min: 1, max: 3, add: 1.5 },
  { name: 'baiyubei', min: 1, max: 2, add: 0.5 },
  { name: 'jinzun', min: 4, max: 6, add: 1.5 },
  { name: 'danglu', min: 4, max: 6, add: 1.5 },
  { name: 'jinlin', min: 5, max: 8, add: 2 },
...
export const SixDataLY: SixDataType[] = [
  ...
  { name: 'dajian', min: 1, max: 2, add: 0.5 },
  { name: 'guixi', min: 4, max: 6, add: 1.5 },
  { name: 'hua', min: 8, max: 12, add: 2 },
  { name: 'mao', min: 1, max: 3, add: 1 },
  { name: 'baiyou', min: 2, max: 4, add: 1.5 },
  { name: 'jinzun', min: 4, max: 6, add: 1.5 },
  { name: 'tongjing', min: 5, max: 8, add: 1.5 },
  { name: 'dizi', min: 5, max: 8, add: 2 },
  { name: 'gou', min: 4, max: 8, add: 1 },
];
